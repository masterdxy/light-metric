 ...
 * {@link Builder#help(String) help},
 * {@link Builder#labelNames(String...) labelNames},
 * {@link Builder#namespace(String) namespace} and
 * {@link Builder#subsystem(String) subsystem} can be called to configure the Collector.
 * These return <code>this</code> to allow calls to be chained.
 * Once configured, call {@link Builder#create create}
 * (which is also called by {@link Builder#register register}).
 * <p>
 * The fullname of the metric is <code>namespace_subsystem_name</code>, but only <code>name</code> is required.
 *
 * <h2>Labels</h2>
 * {@link Builder#labelNames labelNames} specifies which (if any) labels the metrics will have, and
